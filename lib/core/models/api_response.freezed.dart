...
mixin _$ApiResponse<T> {
 ...
 bool? get success; String? get status; String? get message; T? get data;
...
@useResult
$Res call({
 bool? success, String? status, String? message, T? data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool? success,  String? status,  String? message,  T? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool? success,  String? status,  String? message,  T? data)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
return $default(_that.success,_that.status,_that.message,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool? success,  String? status,  String? message,  T? data)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.status,_that.message,_that.data);case _:
  return null;
...
class _ApiResponse<T> implements ApiResponse<T> {
  const _ApiResponse({this.success, this.status, this.message, this.data});
